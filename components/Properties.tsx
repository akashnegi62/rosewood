    ...
    <section className="w-full min-h-screen bg-black flex items-center py-24">
      <div className="w-full max-w-7xl mx-auto px-6 flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-start">
          {/* Nav arrows — top-left stacked boxes */}
          <div className="flex flex-col w-fit border border-white mb-6">
            <motion.button
              onClick={prev}
              disabled={offset === 0}
              whileTap={offset > 0 ? { scale: 0.94 } : {}}
              className="w-14 h-14 flex items-center justify-center border-b border-[#b0a898] transition-colors disabled:opacity-30"
